...
# %% ramka okna programu
        ...
        self.liniaBidSymbol = tk.Label(self.rama, text="BID:", font=("Arial", 8), bg=self.black, fg="#FFD700")
        ...
        self.liniaAskSymbol = tk.Label(self.rama, text="ASK:", font=("Arial", 8), bg=self.black, fg="#FFD700")
